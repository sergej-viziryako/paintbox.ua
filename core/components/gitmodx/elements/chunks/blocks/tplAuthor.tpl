    ...
    <div class="inner">
        ...
        {if $file_exists == 1}
            <a href="{$id | url}" class="img">
                <img class="lazy" data-src="{$_modx->runSnippet('phpthumbon', ['input' => "{$img | replace:'/ru/files/':'/files/'}",'options' => 'w=180&h=140&zc=0&bg=ffff&f=webp'])}" alt="{$pagetitle}" width="180" height="140">
            </a>
        {else}
            <a href="{$id | url}" class="img">
